  ...
  "learningArticles": [
    {
      ...
      "intro": {
        ...
        "whyItMatters": "今回の旅では住宅・公園とサグラダ・ファミリアを比較できます。各作品の訪問日は旅程で確認してください。全部を「不思議な曲線の名所」として急いで通り過ぎず、作品ごとに解こうとした課題が違うと知っておくと、短い外観見学にも意味が生まれます。現地では、形の好みだけでなく、重さ・光・空気・動線・素材のどれを工夫しているかを一つ選んで比べてください。",
        "sourceIds": [
          ...
          "blocks": [
            {
              ...
              "type": "paragraph",
              "text": "作品を比較するなら、Park Güellでは地形と大きな計画を体で感じ、Casa Milà、Casa Batlló、Palau Güell、Casa Vicensでは暮らしの細部へ視点を縮める。Sagrada Famíliaでは構造・光・象徴が巨大な空間へ統合される様子を見る。これは観察の視点であり、訪問順と予約時刻は旅程・入場情報で確認する。",
              "sourceIds": [
                "source-park-guell-emblematic",
                "source-la-pedrera-architecture",
                "source-casa-batllo-interior",
            ...
            },
            {
              ...
              "type": "paragraph",
              "text": "住宅・公園を含む複数の作品を、すべて同じ深さで理解するのは難しい。内部見学する作品では光・換気・動線を一つ選び、外観中心の作品では街路や敷地への応答を一つ選ぶと比較が残る。Casa VicensやPalau Güellの初期性を、後に見るCasa MilàやSagrada Famíliaの「未完成な前段階」と扱わないことも大切である。それぞれが異なる依頼と場所への完成した答えで、その間に方法の広がりがある。\n\n時間と体力の配分は、作品の採用・見送りや旅程変更ではなく、現地でどの比較軸へ集中するかの判断である。大きな仕組みを歩いて理解する余力があればPark Güellの地形かCasa Milàの中庭・設備、中程度の集中力ならCasa Batllóの光井戸、疲れていれば当日実際に入れるPalau GüellかCasa Vicensで一軸だけを選ぶ。Sagrada Famíliaでは、三ファサード、内部の柱と光、本人期と後世の時代差へ順に集中する。営業、公開範囲、入場可否は動的であり、この記事では保証しない。",
              "sourceIds": [
                "source-casa-vicens-original-project",
                "source-palau-guell-trencadis",
                "source-la-pedrera-architecture",
    ...
    },
    {
      ...
      "intro": {
        ...
        "whyItMatters": "今回の旅では塔付き見学を予定しています。予約の日時と入口は旅程・入場情報で確認してください。二つの完成済みファサードを比較し、身廊で構造と光を追い、公開されていれば塔や博物館で視点を変えるには、一つの観察に急がない時間が必要です。料金、時刻、当日の公開範囲はこの記事へ複製せず、関連する場所と予定から確認してください。",
        "sourceIds": [
          "source-sagrada-history-of-temple",
